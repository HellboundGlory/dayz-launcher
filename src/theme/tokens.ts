...
export interface RolesV2 {
  radius: Steps<"window" | "panel" | "card" | "modal" | "popup" | "row" | "control" | "input" | "chip" | "badge" | "thumb" | "track" | "pill">;
  space: Steps<"windowPad" | "panelPad" | "modalPad" | "popupPad" | "rowX" | "rowY" | "controlX" | "controlY" | "chipX" | "chipY" | "stackGap" | "inlineGap" | "sectionGap" | "listGap">;
  type: Partial<Record<"display" | "heading" | "subheading" | "body" | "label" | "caption" | "micro" | "button" | "chip" | "data" | "rowName" | "rowMeta" | "statValue" | "statCaption", TypeRoleV2>>;
  color: Steps<"onAccent" | "onAccent2" | "onDanger" | "focusRing" | "scrim" | "rowHover" | "rowSelected">;
  border: Steps<"hairline" | "control" | "focus">;
  shadow: Steps<"panel" | "modal" | "popup" | "drawer" | "glow">;
...
export const NEUTRAL_TOKENS: TokensV2 & ResolvedTokensV2 = {
  ...
  roles: {
    radius: { window: "lg", panel: "9px", card: "lg", modal: "10px", popup: "7px", row: "lg", control: "md", input: "md", chip: "sm", badge: "3px", thumb: "7px", track: "xs", pill: "full" },
    space: { windowPad: "0", panelPad: "16", modalPad: "14", popupPad: "4", rowX: "12", rowY: "8", controlX: "12", controlY: "6", chipX: "4", chipY: "1px", stackGap: "12", inlineGap: "6", sectionGap: "14", listGap: "6" },
    type: {
    ...
    shadow: { panel: "none", modal: "lg", popup: "sm", drawer: "-10px 0 26px rgba(0,0,0,0.4)", glow: "glow" },
